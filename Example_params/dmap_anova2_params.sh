...
# anova_detail with anova_full or anova_medium can be made to return
# a fold difference

anova_fold_difference="yes";
...
diffmeth_out_name="diffmeth_output_anova2.txt";
